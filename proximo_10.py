def proximo_a_dez(numeros, tolerancia=2): 
    ...
    for num in numeros: # passamos números por números
        ...
        print(f'{resultado} - {diferenca}', True if diferenca <= tolerancia else False) # imprimos o resultado da soma - diferença e verificamos se o número é próximo a 10 com a tolerancia que foi difinada no parâmetro da função, se a diferença for menor ou igual a 2 exibimos True.
